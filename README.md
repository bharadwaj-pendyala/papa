...
[![CI](https://img.shields.io/github/actions/workflow/status/bharadwaj-pendyala/papa/ci.yml?branch=main)](https://github.com/bharadwaj-pendyala/papa/actions)
[![PyPI](https://img.shields.io/pypi/v/papa-lint.svg)](https://pypi.org/project/papa-lint/)
[![Downloads](https://img.shields.io/pypi/dm/papa-lint.svg)](https://pypi.org/project/papa-lint/)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
[![Stars](https://img.shields.io/github/stars/bharadwaj-pendyala/papa?style=social)](https://github.com/bharadwaj-pendyala/papa/stargazers)

[**Quickstart**](#-quickstart) · [**GitHub Action**](#-github-action) · [**LLM loop**](#-the-llm-loop) · [**How it works**](#-how-it-works) · [**Config**](#-configuration)

**[View a live HTML report](docs/assets/sample-report.html)** generated by Papa: hard sentences, passive voice, adverbs, and complex phrases highlighted, with a readability grade panel. Self contained, no network.
...
```bash
pipx install papa-lint   # or: npx papa-lint  ·  brew install papa-lint
...
jobs:
  papa:
    ...
    steps:
      ...
      - uses: bharadwaj-pendyala/papa-action@v1
        with:
...
```bash
docker run --rm -v "$PWD:/work" bharadwaj-pendyala/papa post.md --max-grade 10
```
...
Issues and PRs welcome — see [CONTRIBUTING.md](CONTRIBUTING.md) and our [Code of Conduct](CODE_OF_CONDUCT.md). Good first issues are [labeled](https://github.com/bharadwaj-pendyala/papa/labels/good%20first%20issue).
